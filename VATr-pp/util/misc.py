...
def add_vatr_args(parser):
    ...
    parser.add_argument("--preset", default="spanish", choices=["spanish", "vatrpp"], type=str)
    parser.add_argument("--words_path", default='files/spanish_words.txt', type=str)
    # Backward-compatible alias (do not override words_path unless explicitly set by user code).
    parser.add_argument("--english_words_path", default=None, type=str)
    ...
    parser.add_argument("--alphabet", default=spanish_alphabet, type=str)
    parser.add_argument("--special_alphabet", default='', type=str)
    ...
    parser.add_argument("--scheduler", default="cosine", choices=["cosine", "none"], type=str)
    ...
    parser.add_argument("--strict_split", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--max_width", default=192, type=int)
    parser.add_argument("--max_label_len", default=32, type=int)

    parser.add_argument("--amp", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--amp_dtype", default="fp16", choices=["fp16", "bf16"], type=str)
    parser.add_argument("--grad_clip", default=1.0, type=float)

    parser.add_argument("--ocr_loss_weight", default=1.0, type=float)
    parser.add_argument("--enable_fid", action=argparse.BooleanOptionalAction, default=False)
    parser.add_argument("--save_attn", action=argparse.BooleanOptionalAction, default=False)
    parser.add_argument("--preview_texts", default="hola,¿Qué tal?,niño,ÁÉÍÓÚÜ,áéíóúü,Ñandú,pingüino,123,¡Hola!,¿¡?!,.-;:", type=str)
    parser.add_argument("--rv_sample_size", default=0, type=int)
    parser.add_argument("--restrict_author_ids", default=None, type=str, help="Comma-separated numeric author IDs to use (applied before split).")
    parser.add_argument("--freeze_feat_encoder", action=argparse.BooleanOptionalAction, default=False)

    return parser


# Presets for compatibility with released checkpoints.
VATRPP_BASE_ALPHABET = 'Only thewigsofrcvdampbkuq.A-210xT5\'MDL,RYHJ"ISPWENj&BC93VGFKz();#:!7U64Q8?+*ZX/%'
VATRPP_BASE_SPECIAL = 'ΑαΒβΓγΔδΕεΖζΗηΘθΙιΚκΛλΜμΝνΞξΟοΠπΡρΣσςΤτΥυΦφΧχΨψΩω'
SPANISH_EXTRA = " áéíóúüÁÉÍÓÚÜñÑ0123456789.,;:¿?¡!-"
